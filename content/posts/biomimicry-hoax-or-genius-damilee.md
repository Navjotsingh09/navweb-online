---
title: "Biomimicry: Hoax or Genius? — A Field Note on DamiLee's Provocation"
...
The discipline is the thing worth defending; the marketing is the thing worth attacking. That distinction is the whole reason this journal exists, and it's why our [editorial principles](/topics) are, in order:

1. **Mechanism over metaphor** — if removing the biological reference doesn't remove the function, it was decoration.
2. **Citations not vibes** — every claim in an essay here traces to a primary source.
3. **Built for builders** — the test is whether an engineer or product team could specify the borrowed feature into a brief.
...
**Credit:** Video by [DamiLee](https://www.youtube.com/@DamiLeeArch). Watch *Biomimicry: Hoax or Genius?* on [YouTube](https://www.youtube.com/watch?v=_KowHG5Wbgk).
